...
class ConsciousnessEnum(Enum):
    ALERT = 0
    CVPU = 1  #Have a look at making this work for any non-zero int.


class PatientDetails:

    #Constructor initialises the attributes
    def __init__(self, patient_id : int, air_oxygen: int, consciousness: int, respiration_rate: int, spo2: int, temperature: float):
        ...
        if air_oxygen == AirOxygenEnum.OXYGEN.value or air_oxygen == AirOxygenEnum.AIR.value:
            ...
            while air_oxygen != 0 and air_oxygen != 2:
                air_oxygen = int(input("Invalid input for Air or Oxygen\n"
                                           "please enter 0 for Air or 2 for Oxygen\n"))
                self.AirOxygen = air_oxygen
...
Patient1 = PatientDetails(1,0, 0, 15, 95, 37.1)
...
Patient2 = PatientDetails(2, 2, 0, 17, 95, 37.1)
...
Patient2.SetMediScore(mediscore(Patient2), datetime.datetime.now())
print(Patient2)
#====================================================================================================================================#
print("Test Case 3\n============")
#====================================================================================================================================#
...
# 2+3+2+1 = 8 which == the output.

Patient3 = PatientDetails(3, 2, 1, 23, 88, 38.5)
...
Patient4 = PatientDetails(4, 3, 6, 22, 95, 38.5)
